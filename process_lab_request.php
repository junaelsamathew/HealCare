...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Validate inputs
    if (empty($patient_id) || empty($test_type) || empty($reason)) {
        die(json_encode(['success' => false, 'message' => 'Patient, Test Type, and Clinical Reason are required']));
    }
