                    ...
                    if (!empty($pat_email)) {
                        ...
                        <div style='font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden; color: #1e293b;'>
                            ...
                            <div style='padding: 40px 30px;'>
                                ...
                                <p style='font-size: 16px; line-height: 1.5;'>Hello <strong style='color: #3b82f6;'>" . strtoupper(htmlspecialchars($pat_name)) . "</strong>,</p>
                                ...
                                <div style='background: #f8fafc; border-radius: 12px; padding: 25px; border: 1px solid #f1f5f9;'>
                                    <table style='width: 100%; border-collapse: collapse;'>
                                        ...
                                        <tr>
                                            ...
                                            <td style='padding: 10px 0; text-align: right; font-weight: 700; color: #0f172a;'>" . htmlspecialchars($doc_name) . "</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style='padding: 10px 0; text-align: right; font-weight: 800; color: #3b82f6; font-size: 22px;'>#$token_num</td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div style='background: #f1f5f9; padding: 30px; text-align: center; border-top: 1px solid #e2e8f0;'>
                                ...
                                <p style='margin: 5px 0 0; font-size: 12px; color: #64748b;'>Emergency: (+254) 717 783 146 | Web: www.healcare.com</p>
                            </div>
                        </div>
                        ";
