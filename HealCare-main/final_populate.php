...
$data = [
    // Breakfast
    ['Idli', 'Breakfast', 30, 'https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=400'],
    ['Dosa', 'Breakfast', 40, 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=400'],
    ['Masala Dosa', 'Breakfast', 60, 'https://images.unsplash.com/photo-1630406184470-7fd4440ef826?w=400'],
    ['Vada', 'Breakfast', 20, 'https://images.unsplash.com/photo-1626132646529-5003c40787a7?w=400'],
    ['Upma', 'Breakfast', 40, 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400'],
    ['Poori', 'Breakfast', 50, 'https://images.unsplash.com/photo-1627308595229-7830a5c91f9f?w=400'],
    ['Chapati', 'Breakfast', 20, 'https://images.unsplash.com/photo-1626074353765-517a681e40be?w=400'],
    ['Pongal', 'Breakfast', 50, 'https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=400'],
    ['Bread Toast', 'Breakfast', 30, 'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=400'],
    ['Bread Butter', 'Breakfast', 35, 'https://images.unsplash.com/photo-1593001874117-c99c5edbb862?w=400'],
    ...
    ['Boiled Egg', 'Breakfast', 15, 'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=400'],
    ['Egg Bhurji', 'Breakfast', 50, 'https://images.unsplash.com/photo-1626776878891-628dcd98114f?w=400'],
    ['Egg Sandwich', 'Breakfast', 70, 'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=400'],

    // Lunch
    ['Plain Rice', 'Lunch', 40, 'https://images.unsplash.com/photo-1512058560366-cd2427ff6671?w=400'],
    ...
    ['Tomato Rice', 'Lunch', 65, 'https://images.unsplash.com/photo-1512058560366-cd2427ff6671?w=400'],
    ['Sambar Rice', 'Lunch', 70, 'https://images.unsplash.com/photo-1512058560366-cd2427ff6671?w=400'],
    ['Veg Fried Rice', 'Lunch', 100, 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400'],
    ['Chapati', 'Lunch', 20, 'https://images.unsplash.com/photo-1626074353765-517a681e40be?w=400'],
    ['Butter Roti', 'Lunch', 25, 'https://images.unsplash.com/photo-1626074353765-517a681e40be?w=400'],
    ...
    ['Mixed Veg Curry', 'Lunch', 85, 'https://images.unsplash.com/photo-1588675646184-f5b0b0b0b2de?w=400'],
    ...
    // Dinner
    ['Chapati', 'Dinner', 20, 'https://images.unsplash.com/photo-1626074353765-517a681e40be?w=400'],
    ['Parotta', 'Dinner', 25, 'https://images.unsplash.com/photo-1616070829624-88405a400cc3?w=400'],
    ['Dosa', 'Dinner', 45, 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=400'],
    ['Idli', 'Dinner', 35, 'https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=400'],
    ['Veg Fried Rice', 'Dinner', 110, 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400'],
    ['Egg Fried Rice', 'Dinner', 130, 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400'],
    ...
    ['Vegetable Soup', 'Dinner', 60, 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400'],
    ['Chicken Soup', 'Dinner', 90, 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400'],
    ['Sandwich', 'Dinner', 75, 'https://images.unsplash.com/photo-1521390188846-e2a3ef18035b?w=400'],
    ['Samosa', 'Dinner', 20, 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400'],
    ['Veg Cutlet', 'Dinner', 45, 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400'],
    ['Veg Puff', 'Dinner', 30, 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400'],
    ['Bonda', 'Dinner', 20, 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400'],
    ['Pakoda', 'Dinner', 35, 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400'],
    ['French Fries', 'Dinner', 90, 'https://images.unsplash.com/photo-1630384066202-1777b760b11d?w=400'],
    ['Chips', 'Dinner', 35, 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400'],
    ['Chicken Puff', 'Dinner', 45, 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400'],
    ['Chicken Cutlet', 'Dinner', 65, 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400'],
    ['Egg Puff', 'Dinner', 35, 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400'],
    ...
    // Snacks (Others)
    ['Pickle', 'Snacks', 10, 'https://images.unsplash.com/photo-1589135339689-19aa8bc4ed15?w=400'],
    ['Papad', 'Snacks', 10, 'https://images.unsplash.com/photo-1589135339689-19aa8bc4ed15?w=400'],
    ['Curd', 'Snacks', 25, 'https://images.unsplash.com/photo-1512058560366-cd2427ff6671?w=400'],
    ['Ghee', 'Snacks', 40, 'https://images.unsplash.com/photo-1589135339689-19aa8bc4ed15?w=400'],
    ['Sauce', 'Snacks', 5, 'https://images.unsplash.com/photo-1589135339689-19aa8bc4ed15?w=400'],

    // Patient Special
    ['Soft Rice', 'Patient Special', 45, 'https://images.unsplash.com/photo-1512058560366-cd2427ff6671?w=400'],
    ['Plain Khichdi', 'Patient Special', 65, 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400'],
    ['Steamed Vegetables', 'Patient Special', 75, 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400'],
    ['Oats Porridge', 'Patient Special', 85, 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400'],
    ['Ragi Kanji', 'Patient Special', 55, 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400']
];
...
echo "Final Cleanup: Inserted $inserted items.";
?>
