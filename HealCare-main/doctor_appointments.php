...
if ($filter_status != 'all') {
    ...
    $where_conditions[] = "a.status = '$safe_status'";
}
            ...
            <div class="filter-bar">
                ...
                <div class="filter-group">
                    ...
                    <select class="filter-select" id="filterDate" onchange="applyFilters()">
                        ...
                        <option value="past" <?php echo $filter_date == 'past' ? 'selected' : ''; ?>>Past</option>
                    </select>
                </div>

                <?php if ($filter_status != 'all' || $filter_date != 'all'): ?>
                    <button class="btn-reset" onclick="resetFilters()"><i class="fas fa-redo"></i> Reset Filters</button>
                <?php endif; ?>
            </div>
