...
// --- RAZORPAY CONFIG ---
// NOTE: Hardcoded for Demo. In production, use Environment Variables.
...
if (!isset($input['amount']) || !isset($input['bill_id'])) {
    http_response_code(400);
    echo json_encode(['error' => 'Missing amount or bill_id']);
    exit;
}

$amount = $input['amount']; // Amount in INR
$receipt = "bill_" . $input['bill_id'];
